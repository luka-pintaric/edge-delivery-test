...
## Environments
- Preview: https://main--edge-delivery-test--luka-pintaric.aem.page/
- Live: https://main--edge-delivery-test--luka-pintaric.aem.live/
...
1. Open the `edge-delivery-test` directory in your favorite IDE and start coding :)
